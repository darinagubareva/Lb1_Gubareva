...
int main() {
    ...
    cout << "Демонстрація перевантажених операцій:" << endl;

    Point p1, p2, p3;

    cout << "Введіть точку p1:" << endl;
    cin >> p1;

    cout << "Введіть точку p2:" << endl;
    cin >> p2;
    ...
    if (p1 == p2) {
        cout << "p1 == p2: точки збігаються" << endl;
    }
    else {
        cout << "p1 == p2: точки не збігаються" << endl;
    }

    Point p4;
    p4 = p1;
    cout << "Після p4 = p1: p4 = " << p4 << endl;
